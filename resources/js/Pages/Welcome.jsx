        ...
        <>
            ...
            <div
                ...
                <div className='flex flex-col justify-center mx-auto mt-20'>
                    <h1 className='text-white text-4xl md:text-5xl font-bold font-sans'>Jual Hasil Panen Langsung</h1>
                    <h1 className='text-white text-4xl md:text-5xl font-bold font-sans md:text-center mt-5 w-fit md:mx-auto'>ke Pembeli</h1>
                    <p className='text-white text-xl bg-lime-500 rounded-lg px-3 py-1 w-fit mt-5 md:mx-auto'> Belanja Hasil Pertanian</p>
                    <p className='text-white text-xl bg-lime-500 rounded-lg px-3 py-1 w-fit mt-2 md:mx-auto'> Mudah dan Hemat!</p>
                </div>
            </div>
