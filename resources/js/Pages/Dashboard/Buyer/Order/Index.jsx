    ...
    return (
        <BuyerLayout>
            {orders.map((order) => (
                <div
                    key={order.id}
                    className="flex flex-col justify-start p-5 mx-auto mt-20 border-2 border-dashed rounded-lg shadow-md h-fit w-fit border-amber-300"
                >
                    ...
                    {order.product && (
                        <div className="flex flex-row items-start justify-between gap-4 mt-2">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <button className="p-1 text-sm font-medium text-black rounded-lg border-1 border-amber-500">
                                    Cancel
                                </button>
                            </div>
                        </div>
