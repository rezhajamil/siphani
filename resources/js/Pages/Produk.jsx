                ...
                <div className="flex flex-col items-center justify-center w-full min-h-screen px-16 bg-white py-25 md:py-20">
                    <div className="flex flex-col mt-20 md:mt-0">
                        ...
                        <p className="text-sm font-medium text-center md:text-md">
                            Kami menawarkan beragam produk hasil pertanian mulai
                            dari beras, buah-buahan, sayuran.
                        </p>
                        <p className="text-sm font-medium text-center md:text-md">
                            Dengan berbagai pilihan yang tersedia, Anda dapat
                            dengan mudah menemukan produk yang sesuai dengan
                            kebutuhan dan preferensi Anda.
                        </p>
                        <button className="px-4 py-2 mx-auto mt-5 text-base font-medium text-center text-white rounded-lg bg-amber-500 w-fit hover:bg-amber-400">
                            Mulai Belanja
                        </button>
