        ...
        <Template>
            ...
            <div className='w-full bg-white min-h-screen py-15 md:py-10 px-16 flex justify-center items-center flex flex-col'>
                <div className='flex flex-col mt-20 md:mt-0'>
                    ...
                    <p className='text-center font-medium text-sm md:text-md'>Kami menawarkan beragam produk hasil pertanian mulai dari buah-buahan, sayuran.</p>
                    ...
                    <button className="bg-amber-500 px-3 md:px-4 py-2 rounded-lg text-white text-base font-medium text-center w-fit mx-auto mt-5 hover:bg-amber-400">Mulai Belanja</button>
                </div>
