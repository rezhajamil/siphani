...
const handleOpenShopClick = () => {
    ...
    if (userConfirmed) {
        window.location.href =
            "/user/change-role?role=Seller&route=seller.shop.index";
    }
};
...
const authItems = [
    ...
    },
    {
        ...
        label: "Buka Toko",
        className:
            "bg-amber-500 w-fit px-4 py-3 rounded-lg text-white text-base font-medium cursor-pointer",
    },
    {
        route: "/logout",
        label: "Logout",
...
const BuyerLayout = ({ auth, children, unreadNotif }) => {
    return (
        <div className="flex flex-col min-h-screen">
            <Navbar
                ...
                onOpenShopClick={handleOpenShopClick}
            />
